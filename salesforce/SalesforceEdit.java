...
public class SalesforceEdit {
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(600);
		driver.findElement(By.xpath("//input[@name='Account-search-input']")).sendKeys("Pratheep",Keys.ENTER);
		Thread.sleep(3000);
		driver.findElement(By.xpath("//a[text()='Pratheep']")).click();
		...
		driver.findElement(By.xpath("//input[@name='Name']")).sendKeys("Vikram Pratheep");
